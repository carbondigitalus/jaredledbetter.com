<?php
	// Your Email
	$recipient = "jared@carbondigital.us"; // PLEASE SET YOUR EMAIL ADDRESS
	$recaptcha_secret_key = '6LfRYqQUAAAAACAopwKTbwbVQedagkloHwgg3Oo_'; // PLEASE SET YOUR GOOGLE RECAPTCHA API KEY. If you are not using, please leave it blank.
	...
	if(isset($_POST["g-recaptcha-response"]) && $recaptcha_secret_key !== '6LfRYqQUAAAAACAopwKTbwbVQedagkloHwgg3Oo_') {
